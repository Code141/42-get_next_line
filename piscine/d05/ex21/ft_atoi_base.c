...
/*   Updated: 2017/09/11 12:23:29 by gelambin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_str_is_base(char *str, char *base, int size)
{
	int i;
	int j;
...
int		ft_find_index_in_base(char c, char *base)
{
	int i;
...
int		ft_convert(char *str, char *base, int size)
{
	int i;
	int nb;
	int current_based;
